...
import { MapPin, Clock, Users, Star, ShieldCheck, Car } from "lucide-react";
...
export function InviteCard({
  ...
  return (
    <Card className="hover-elevate" data-testid={`card-invite-${userName}`}>
      ...
      <CardFooter className="pt-0">
        <Button className="w-full" data-testid="button-request-ride">
          Request to Join
        </Button>
      </CardFooter>
    </Card>
